...
2. Look for the latest Windows release or file.
3. Download the app to your PC.
4. If the file comes as a ZIP, extract it to a folder you can find again.
5. If you get an `.exe` file, double-click it to run the app.
...
4. Run the app file.
5. If the app opens in a terminal window, leave that window open while you use Claude Code.
6. Start Claude Code and check that the status line appears.
...
- Make sure the `.git` folder is present
- Open the project folder again in Claude Code
...
### Can I use it with any Claude Code project?
...
6. Use the status line while you work